...
const REPEATABLE_PRIORITY: RepeatableUpgradeId[] = ['politicalNetworking', 'constituencyResearch', 'talentHeadhunters', 'researchEndowments', 'patronageMachine', 'automationSubsidies', 'infrastructureGrants', 'internDeskTraining', 'internPlaybooks', 'internLabTraining', 'internResearchNotes', 'juniorTraderTraining', 'behavioralModeling', 'juniorLabProtocols', 'juniorLabOptimization', 'seniorDeskPerformance', 'decisionSystems', 'propDeskScaling', 'propDeskResearch', 'institutionalDeskCoordination', 'institutionalAnalytics', 'hedgeFundExecution', 'hedgeFundResearch', 'investmentFirmOperations', 'firmWideSystems', 'seniorLabMethods', 'seniorLabOptimization', 'ruleBasedExecution', 'signalRefinement', 'energyOptimization', 'rackDensity', 'serverRoomExpansion', 'dataCenterOverbuild', 'cloudFailover', 'mlModelDeployment', 'mlFeaturePipelines', 'aiClusterOrchestration', 'aiTrainingSystems', 'serverEfficiency']
